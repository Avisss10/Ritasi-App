...
const deleteSupirName = document.getElementById('deleteSupirName');
...
function openAddModal() {
    currentEditId = null;
    modalTitle.textContent = 'Tambah Supir';
    namaInput.value = '';
...
function openEditModal(id) {
    ...
    if (data) {
        modalTitle.textContent = 'Edit Supir';
...
function openDeleteModal(id) {
    ...
    if (data) {
        deleteSupirName.textContent = data.nama;
...
async function handleSubmit(e) {
    ...
    if (!nama) {
        showAlert('Nama supir tidak boleh kosong', 'error');
        return;
    }
        ...
        tableBody.innerHTML = `
            <tr>
                <td colspan="3" class="empty-state">
                    ...
                    <button class="btn btn-primary" onclick="openAddModal()">+ Tambah Supir Pertama</button>
                </td>
            </tr>
        `;
        return;
